...
struct ChimeraWidget : ModuleWidget {
    ...
    ChimeraWidget(Chimera* module) {
        ...
        addParam(createParamCentered<Trimpot>(mm2px(point("GENE_ATT_PARAM", Vec(49, 56))), module, Chimera::GENE_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(point("VARISPEED_ATT_PARAM", Vec(99, 56))), module, Chimera::VARISPEED_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(point("SLIDE_ATT_PARAM", Vec(96, 73))), module, Chimera::SLIDE_ATT_PARAM));
        addParam(createParamCentered<LEDButton>(mm2px(point("REC_PARAM", Vec(14, 79))), module, Chimera::REC_PARAM));
        addParam(createParamCentered<LEDButton>(mm2px(point("SPLICE_PARAM", Vec(36, 79))), module, Chimera::SPLICE_PARAM));
        addParam(createParamCentered<LEDButton>(mm2px(point("SHIFT_PARAM", Vec(58, 79))), module, Chimera::SHIFT_PARAM));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("SOS_CV_INPUT", Vec(12, 93))), module, Chimera::SOS_CV_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("GENE_SIZE_CV_INPUT", Vec(36, 93))), module, Chimera::GENE_SIZE_CV_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("VARISPEED_CV_INPUT", Vec(60, 93))), module, Chimera::VARISPEED_CV_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("MORPH_CV_INPUT", Vec(84, 93))), module, Chimera::MORPH_CV_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("SLIDE_CV_INPUT", Vec(108, 93))), module, Chimera::SLIDE_CV_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("ORGANIZE_CV_INPUT", Vec(132, 93))), module, Chimera::ORGANIZE_CV_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("CLOCK_INPUT", Vec(20, 103))), module, Chimera::CLOCK_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("PLAY_INPUT", Vec(45, 103))), module, Chimera::PLAY_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("REC_INPUT", Vec(70, 103))), module, Chimera::REC_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("SPLICE_INPUT", Vec(95, 103))), module, Chimera::SPLICE_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("SHIFT_INPUT", Vec(120, 103))), module, Chimera::SHIFT_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("AUDIO_L_INPUT", Vec(12, 111))), module, Chimera::AUDIO_L_INPUT));
        addInput(createInputCentered<Magitek2InputJack>(mm2px(point("AUDIO_R_INPUT", Vec(36, 111))), module, Chimera::AUDIO_R_INPUT));
        addOutput(createOutputCentered<Magitek2OutputJack>(mm2px(point("AUDIO_L_OUTPUT", Vec(60, 111))), module, Chimera::AUDIO_L_OUTPUT));
        addOutput(createOutputCentered<Magitek2OutputJack>(mm2px(point("AUDIO_R_OUTPUT", Vec(84, 111))), module, Chimera::AUDIO_R_OUTPUT));
        addOutput(createOutputCentered<Magitek2OutputJack>(mm2px(point("CV_OUTPUT", Vec(108, 111))), module, Chimera::CV_OUTPUT));
        addOutput(createOutputCentered<Magitek2OutputJack>(mm2px(point("EOSG_OUTPUT", Vec(132, 111))), module, Chimera::EOSG_OUTPUT));
        addChild(createLightCentered<SmallAperture<RedApertureLight>>(mm2px(point("REC_LIGHT", Vec(10, 39))), module, Chimera::REC_LIGHT));
        addChild(createLightCentered<SmallAperture<AmberApertureLight>>(mm2px(point("REC_ARMED_LIGHT", Vec(25, 39))), module, Chimera::REC_ARMED_LIGHT));
        addChild(createLightCentered<SmallAperture<GreenApertureLight>>(mm2px(point("PLAY_LIGHT", Vec(40, 39))), module, Chimera::PLAY_LIGHT));
        addChild(createLightCentered<SmallAperture<AmberApertureLight>>(mm2px(point("PENDING_LIGHT", Vec(56, 39))), module, Chimera::PENDING_LIGHT));
        addChild(createLightCentered<SmallAperture<BlueApertureLight>>(mm2px(point("CLOCK_LIGHT", Vec(72, 39))), module, Chimera::CLOCK_LIGHT));
        addChild(createLightCentered<SmallAperture<VioletApertureLight>>(mm2px(point("PM_LIGHT", Vec(88, 39))), module, Chimera::PM_LIGHT));
        addChild(createLightCentered<SmallAperture<WhiteApertureLight>>(mm2px(point("IO_BUSY_LIGHT", Vec(103, 39))), module, Chimera::IO_BUSY_LIGHT));
        addChild(createLightCentered<SmallAperture<RedApertureLight>>(mm2px(point("CLIP_LIGHT", Vec(118, 39))), module, Chimera::CLIP_LIGHT));
        addChild(createLightCentered<SmallAperture<RedApertureLight>>(mm2px(point("ERROR_LIGHT", Vec(133, 39))), module, Chimera::ERROR_LIGHT));
    }
    void step() override {
        const bool measurePerf = isDragonKingDebugEnabled();
