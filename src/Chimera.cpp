...
struct ChimeraWidget : ModuleWidget {
    ...
    ChimeraWidget(Chimera* module) {
        ...
        addParam(createParamCentered<RoundBlackKnob>(mm2px(point("SOS_PARAM", Vec(118.24, 51))), module, Chimera::SOS_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(point("GENE_SIZE_PARAM", Vec(24, 51))), module, Chimera::GENE_SIZE_PARAM));
        ...
        addParam(createParamCentered<RoundBlackKnob>(mm2px(point("MORPH_PARAM", Vec(24, 80))), module, Chimera::MORPH_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(point("SLIDE_PARAM", Vec(71.12, 80))), module, Chimera::SLIDE_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(point("ORGANIZE_PARAM", Vec(118.24, 80))), module, Chimera::ORGANIZE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(point("GENE_ATT_PARAM", Vec(34, 67))), module, Chimera::GENE_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(point("VARISPEED_ATT_PARAM", Vec(81.12, 67))), module, Chimera::VARISPEED_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(point("SLIDE_ATT_PARAM", Vec(81.12, 93))), module, Chimera::SLIDE_ATT_PARAM));
