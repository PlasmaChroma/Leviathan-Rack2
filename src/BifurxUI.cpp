...
struct BifurxWidget final : ModuleWidget {
	...
	explicit BifurxWidget(Bifurx* module) {
		...
		addParam(createParamCentered<RoundBlackKnob>(mm2px(lP), module, Bifurx::LEVEL_PARAM)); addParam(createParamCentered<GearKnobInvertDaviesSized>(mm2px(fP), module, Bifurx::FREQ_PARAM)); addParam(createParamCentered<RoundBlackKnob>(mm2px(rP), module, Bifurx::RESO_PARAM));
		...
		addInput(createInputCentered<DarkPJ301MPort>(mm2px(rcP), module, Bifurx::RESO_CV_INPUT)); addInput(createInputCentered<DarkPJ301MPort>(mm2px(bcP), module, Bifurx::BALANCE_CV_INPUT)); addInput(createInputCentered<DarkPJ301MPort>(mm2px(scP), module, Bifurx::SPAN_CV_INPUT));
