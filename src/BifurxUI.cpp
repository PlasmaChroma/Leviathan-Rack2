...
struct BifurxWidget final : ModuleWidget {
	...
	explicit BifurxWidget(Bifurx* module) {
		...
		addParam(createParamCentered<RoundBlackKnob>(mm2px(lP), module, Bifurx::LEVEL_PARAM)); addParam(createParamCentered<GearKnobInvertSized>(mm2px(fP), module, Bifurx::FREQ_PARAM)); addParam(createParamCentered<RoundBlackKnob>(mm2px(rP), module, Bifurx::RESO_PARAM));
