...
#define SHA1_Init DOOM_SHA1_Init
#define SHA1_Update DOOM_SHA1_Update
#define SHA1_Final DOOM_SHA1_Final
#define SHA1_UpdateInt32 DOOM_SHA1_UpdateInt32
#define SHA1_UpdateString DOOM_SHA1_UpdateString
