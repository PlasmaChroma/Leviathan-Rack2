...
## Unknown Title - Virtual Theramin
- Could provide both audio and CV outputs
- Add an enable button so stray mouse swipes don't play it
- Could have a gate out for mouse "inside"

## Unknown Title - "Blank" visualizer panel
- Stylized dragon graphic (Leviathan)
- Could be a level meter
- Dragon breathes fire if over -1.0dBFS
- Also LUFS display?
