...
TestResult testPopulateHostMessageCopiesPreviewAndScalars() {
  ...
  temporaldeck_expander::populateHostMessage(&msg, 42u, 7u,
                                             ...
                                             48000.f, 321.f, 640.f, 1.25f, 0.5f, 10.f, 0.05f, 6.25f, 2.5f, 9000u, 4500u, 900.f,
                                             1120.f, 1000.f, 1.75f, 24.f, 2u, scope.data());
  ...
  bool pass = msg.magic == temporaldeck_expander::MAGIC && msg.version == temporaldeck_expander::VERSION &&
              ...
              msg.scopeVisibleStartLagSamples == 1000.f &&
              msg.scopeBinSpanSamples == 1.75f && msg.scopeNewestPosSamples == 24.f &&
              msg.sampleAbsolutePeakVolts == 6.25f &&
              msg.scratchSensitivity == 2.5f && msg.scopeBinCount == 2u &&
