...
TestResult monophonicReferenceIsStable(const std::vector<Trace>& traces) {
  // Rack generates MinBLEP impulses in its platform runtime. Substituting the
  // Linux impulse into the Windows harness reproduces every Linux trace/hash
  // exactly; keep strict native references without changing the released DSP.
  static const Summary expected[] {
#ifdef _WIN32
      {161.29912575986236, 58277.659040547835, 161.30947360303253, 58261.236935288136, -299.36692380905151, 101227.57582373166, 0, 0, 261.62997436523438, 0, 5.0133771896362305},
      {-441.89271344942972, 59065.200999305729, 930.6217290838249, 49787.849486682564, -5.1535663604736328, 101303.0253989847, 0, 0, 279.27716064453125, 0.47906249761581421, 5.0140213966369629},
      {-71.959524107398465, 102470.11066392751, -71.907257986487821, 102413.02820407863, 4.9535007476806641, 194983.87456740972, 913.76947635051147, 0, 1010.3325805664062, 0, 5.0339879989624023},
      {-5.6509519279934466, 116688.18026702416, -9.4210534752346575, 116611.08958211764, -32.256041049957275, 195836.94124126813, 992.47948556949632, 0, 1010.3325805664062, 0, 6.3920326232910156},
      {-14.530783014371991, 116732.37804457275, -19.493216888979077, 116641.72628540231, -724.79958510398865, 200220.17075678782, 1891.6302246958949, 0, 1010.3325805664062, 0, 6.7761187553405762},
      {-85.849561918294057, 54989.906996349171, 1326.3478570694569, 45731.87330666183, 243.69882345199585, 51957.064915646086, 0, 3160.1361015290022, 261.6256103515625, 0.41999998688697815, 5.0225763320922852},
#else
...
#ifdef _WIN32
      8612068578004439136ull,
      12221184572286954511ull,
      11525515621849054953ull,
      12712808793549590116ull,
      13832131164925748537ull,
      12026326469282986458ull,
#else
