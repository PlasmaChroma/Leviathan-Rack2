...
SOURCE_FILES = (
    ...
    "src/BifurxRenderClient.cpp",
    "src/BifurxRenderClient.hpp",
    "src/BifurxTypes.hpp",
    "src/BifurxDsp.hpp",
    "src/BifurxModule.hpp",
    "src/BifurxDisplay.hpp",
    "src/BifurxPreview.hpp",
    "src/BifurxPreview.cpp",
    "src/BifurxState.cpp",
    "src/BifurxSpectrumNanoVG.hpp",
    "src/BifurxSpectrumNanoVG.cpp",
    "src/BifurxDebug.hpp",
    "src/BifurxDebug.cpp",
    "src/Bifurx.hpp",
    ...
    "src/visual/SharedSvgCache.cpp",
    "src/visual/SharedSvgCache.hpp",
    "src/visual/SharedSvgCacheState.hpp",
